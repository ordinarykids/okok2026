...
export const cv: CVData = {
  ...
  "experience": [
    ...
    },
    {
      ...
      "description": "Modernized how public media connects with its audience — leading design and technology that transformed KQED.org and the systems behind it. Focused on prototyping, modernization, and building the technical foundation for new kinds of storytelling.",
      "bullets": [
    ...
    },
    {
      ...
      "description": "Helped transform KQED’s digital presence from a traditional broadcaster into a modern, audience-driven media platform — blending UX strategy, product design, and hands-on prototyping for millions of listeners and readers.",
      "bullets": [
    ...
    },
    {
      ...
      "description": "Formed in the midst of the dot-com fallout, OrdinaryKids produced over a decade of award-winning, thought-provoking work. By building mostly direct-to-client relationships, the studio shaped and augmented brands across the skate, architecture, and fashion worlds.",
      "bullets": [
