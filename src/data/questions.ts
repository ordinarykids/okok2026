...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answer: [
      "Honestly, I don't want to ask him about the business — I have tons of questions about Sesame, plenty of opinions about what's worked and what hasn't, but that's not the conversation I want. What I want to get at is something about the interface itself.",
      "Voice as an additive layer on phones and desktops is interesting. But the moment it becomes an always-on input — part of a single continuous system, like you and the thing you're wearing are in one loop — it turns into a different kind of communication entirely. That's the transition I want to hear him think out loud about.",
      "The mechanics of the conversation are going to get solved. Full duplex, low latency, emotional expressiveness — Sesame is closer to that than anyone, and the field will get there. The harder problem, the one that ends up defining whether any of this feels like a relationship, is the content underneath: memory, shared context, the accumulated understanding of who you are. Themes, trajectories, hopes, the way a mind chooses what to come back to. That's what makes something feel known by you, not just responsive to you. So — where does he think we get there? What's the vision for the layer underneath the voice?",
      "Because to me that's the thing. We're at a moment where a new kind of intelligence is emerging in ways our species hasn't seen before, and the people designing its interface get to shape what the relationship between humans and that intelligence actually feels like. That's the most interesting design problem I can imagine, and I want to hear how he thinks about it.",
    ],
  },
];
