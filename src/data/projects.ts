...
<p>Hello Intuit was an extension of the voice work I\u2019d been brought in for \u2014 we built it the same week as Lead Lingo. Two of these in about seven days, which in retrospect was nuts.</p>
<p>Lead Lingo connected a voice agent to backend tools. Hello Intuit asked a different question: what if voice didn\u2019t just talk to the backend \u2014 what if it talked to the interface itself? Could we lay an additive conversational layer over the surface already in your hand? The phone becomes the vehicle. It follows you, stays with you, reaches out when it needs to. Less an app you open, more a kind of soul interface \u2014 something that lives next to you through the day.</p>
<p>The working prototype followed Alex \u2014 a content creator filing as a sole proprietor, trying to reduce taxes and set up for growth. Hello Intuit recognized Alex\u2019s QuickBooks data, recommended an S-corp conversion, walked through the filing steps, and jumpstarted the business tax return, all through natural conversation on the device she already carried. It wasn\u2019t voice as novelty. It was voice as the layer that makes the whole surface feel awake.</p>
<h3>Intuit Intelligence</h3>
<p>The prototype started as a thought experiment and evolved into something larger \u2014 a platform vision we called Intuit Intelligence. Agent-to-agent handoffs. A morning notebook that greets you with what actually matters. Small, hyper-personal touch points through the day that keep a business owner engaged without burning them out. The assistant doesn\u2019t live inside a single product; it lives with you.</p>
<p>The thread underneath the whole thing: the best native AI won\u2019t feel like software. It\u2019ll feel familiar, and it\u2019ll feel next to you.</p>
<h3>Omni</h3>
<p>From there the idea evolved again \u2014 into a company-wide initiative called Omni, a chat-first interface in the shape that ChatGPT has now made legible to the world. Our argument was that voice sits on top as the additive modality layer: voice, text, notifications, the same mix of channels humans already use with each other. One intelligence, many ways in.</p>
<h3>What it set in motion</h3>
<p>Most of this isn\u2019t shipped yet. Internally, the argument over whether voice even belongs inside finance is still being had. This early prototype is part of what set the larger trajectory in motion \u2014 we walked it through leadership many, many times. A lot of it didn\u2019t land. People don\u2019t always see where conversation fits inside financial software, and if you don\u2019t see how natural language connects to the evolution of interfaces, there\u2019s only so far a demo can carry the conversation. At some point you stop arguing and go build the next thing.</p>`,
    featuredImage: {
